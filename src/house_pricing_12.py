# -*- coding: utf-8 -*-
"""House_Pricing_12.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UbtLIRPw-Gbqb4Srd4LOLI6gMJPwWkbx
...
pickle.dump(elastic_model3, open(mydir + "elastic_model.sav", 'wb'))
pickle.dump(lasso_model2, open(mydir + "lasso_model.sav", 'wb'))
pickle.dump(ridge_model2, open(mydir + "ridge_model.sav", 'wb'))
pickle.dump(svr_fit, open(mydir + "svr_model.sav", 'wb'))
pickle.dump(xgb_fit, open(mydir + "xgb_model.sav", 'wb'))
pickle.dump(lgbm_fit, open(mydir + "lgb_model.sav", 'wb'))
